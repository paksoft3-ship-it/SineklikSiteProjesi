...
export default function WoodenWhitePage() {
  return (
      ...
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Witte Houten Jaloezieën</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Klassieke witte afwerking voor een frisse, tijdloze look.</p>
          </div>
        </div>
      </section>
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-8">Witte houten jaloezieën zijn tijdloos en passen bij vrijwel elk interieur.</p>
