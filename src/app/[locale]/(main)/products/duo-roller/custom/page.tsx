...
export default function CustomDuoRollerPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Volledig op maat gemaakte duo rolgordijnen voor een perfecte pasvorm.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl font-bold text-secondary dark:text-white mb-6">
                Perfecte balans gegarandeerd
              </h2>
              <div className="space-y-4">
                {[
                  { icon: 'fa-ruler-combined', title: 'Exact op maat', desc: 'Tot op de millimeter nauwkeurig' },
                  { icon: 'fa-palette', title: '50+ kleuren', desc: 'Uitgebreide kleurencollectie' },
                  { icon: 'fa-adjust', title: 'Variabele privacy', desc: 'Wissel tussen open en gesloten' },
