...
const products = [
  {
    id: 'duo-light-white',
    name: 'Duo Lichtdoorlatend Wit',
    description: 'Wit duo rolgordijn met zachte lichtfiltering.',
    price: 69,
    image: '/images/nav/curtain-light.png',
    features: ['Lichtdoorlatend', 'Wit', 'Variabele privacy'],
  },
  {
    id: 'duo-light-cream',
    name: 'Duo Lichtdoorlatend Crème',
    description: 'Crème duo rolgordijn voor een warme sfeer.',
    price: 69,
    image: '/images/nav/curtain-light.png',
    features: ['Lichtdoorlatend', 'Crème', 'Warm'],
  },
  {
    id: 'duo-light-grey',
    name: 'Duo Lichtdoorlatend Grijs',
    description: 'Grijs duo rolgordijn voor een moderne uitstraling.',
    price: 79,
    image: '/images/nav/curtain-light.png',
    features: ['Lichtdoorlatend', 'Grijs', 'Modern'],
  },
];

export default function DuoLightFilteringPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Zachte lichtfiltering met variabele privacy. Perfect voor woonkamers.
            </p>
          </div>
        </div>
      </section>
