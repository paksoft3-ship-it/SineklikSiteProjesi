...
const products = [
  { id: 1, name: 'Duo Verduisterend Wit', price: '€79,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 2, name: 'Duo Verduisterend Grijs', price: '€85,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 3, name: 'Duo Verduisterend Zwart', price: '€85,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 4, name: 'Duo Verduisterend Antraciet', price: '€82,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
];

export default function DuoRollerBlindsBlackoutPage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Verduisterende Duo Rolgordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Zebra-effect met verduisterende stroken voor maximale privacy.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Configureer uw verduisterende duo rolgordijn precies op maat.</p>
