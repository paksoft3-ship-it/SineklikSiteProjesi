...
const products = [
  { id: 1, name: 'Duo Standaard Wit 60x180', price: '€45,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 2, name: 'Duo Standaard Grijs 80x180', price: '€52,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 3, name: 'Duo Standaard Beige 100x180', price: '€59,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 4, name: 'Duo Standaard Zwart 120x180', price: '€65,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
];

export default function DuoRollerBlindsReadyMadePage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Kant-en-klare Duo Rolgordijnen</h1>
      ...
      <section className="py-16 bg-bg-light-2 dark:bg-bg-dark-2">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Configureer uw duo rolgordijn op maat voor de perfecte pasvorm.</p>
          <Link href="/products/duo-roller-blinds/custom" className="inline-flex items-center px-6 py-3 bg-primary text-white font-bold rounded-lg hover:bg-blue-600 transition">
