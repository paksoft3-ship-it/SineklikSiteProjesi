...
export default function DuoRollerBlindsCustomPage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Duo Rolgordijnen op Maat</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Configureer uw perfecte duo rolgordijn met onze maatwerk service.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: 'fa-palette', title: 'Kleurkeuze', desc: 'Kies uit een ruim assortiment kleuren en patronen.' },
              { icon: 'fa-layer-group', title: 'Zebra Effect', desc: 'Uniek gestreept design voor sfeer en functionaliteit.' },
            ].map((item, i) => (
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Ontwerp uw perfecte duo rolgordijn in enkele stappen.</p>
