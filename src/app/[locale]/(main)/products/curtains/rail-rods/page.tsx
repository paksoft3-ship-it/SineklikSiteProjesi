...
const products = [
  {
    id: 'railrod-classic',
    name: 'Klassiek Railroede',
    description: 'Combinatie van rail en roede voor maximale flexibiliteit.',
    price: 59,
    image: '/images/nav/curtain-rails.png',
    features: ['Combinatie', 'Flexibel', 'Klassiek'],
  },
  {
    id: 'railrod-modern',
    name: 'Modern Railroede',
    description: 'Strak design met dubbele functionaliteit.',
    price: 69,
    image: '/images/nav/curtain-rails.png',
    features: ['Modern', 'Strak', 'Dubbel'],
  },
  {
    id: 'railrod-double',
    name: 'Dubbel Railroede',
    description: 'Dubbele track voor vitrage en overgordijn.',
    price: 79,
    image: '/images/nav/curtain-rails.png',
    features: ['Dubbel', 'Vitrage + Gordijn', 'Praktisch'],
  },
];

export default function RailRodsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Combinatie van rail en roede voor flexibiliteit en stijl.
            </p>
          </div>
        </div>
      </section>
