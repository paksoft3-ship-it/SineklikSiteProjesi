...
const products = [
  {
    id: 'light-linen',
    name: 'Linnen Lichtdoorlatend',
    description: 'Natuurlijke linnen gordijnen met zachte lichtfiltering.',
    price: 89,
    image: '/images/nav/curtain-light.png',
    features: ['50% lichtdoorlatend', 'Linnen', 'Natuurlijk'],
  },
  {
    id: 'light-cotton',
    name: 'Katoen Lichtdoorlatend',
    description: 'Zachte katoenen gordijnen voor een warme sfeer.',
    price: 69,
    image: '/images/nav/nav-gordijn-licht.jpg',
    features: ['60% lichtdoorlatend', 'Katoen', 'Wasbaar'],
  },
  {
    id: 'light-poly',
    name: 'Polyester Lichtdoorlatend',
    description: 'Onderhoudsvriendelijke gordijnen met goede lichtfiltering.',
    price: 59,
    image: '/images/nav/curtain-light.png',
    features: ['55% lichtdoorlatend', 'Polyester', 'Kreukvrij'],
  },
];

export default function LightFilteringCurtainsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Zachte lichtfiltering met behoud van privacy. Perfect voor woonkamers en keukens.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-white dark:bg-gray-800 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: 'fa-sun', title: 'Lichtfiltering', desc: '50-70% lichtdoorlatend' },
              { icon: 'fa-eye-slash', title: 'Privacy', desc: 'Overdag privacy' },
              { icon: 'fa-palette', title: 'Veel Kleuren', desc: '100+ kleuropties' },
