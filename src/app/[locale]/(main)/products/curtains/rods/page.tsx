...
const products = [
  {
    id: 'rods-wood',
    name: 'Houten Gordijnroedes',
    description: 'Klassieke houten roedes voor een warme uitstraling.',
    price: 49,
    image: '/images/nav/curtain-rails.png',
    features: ['Hout', 'Klassiek', 'Warm'],
  },
  {
    id: 'rods-metal',
    name: 'Metalen Gordijnroedes',
    description: 'Moderne metalen roedes voor een industriële look.',
    price: 39,
    image: '/images/nav/curtain-rails.png',
    features: ['Metaal', 'Modern', 'Industrieel'],
  },
  {
    id: 'rods-brass',
    name: 'Messing Gordijnroedes',
    description: 'Elegante messing roedes voor een luxe uitstraling.',
    price: 69,
    image: '/images/nav/curtain-rails.png',
    features: ['Messing', 'Luxe', 'Elegant'],
  },
];

export default function CurtainRodsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Klassieke roedes voor een tijdloze uitstraling.
            </p>
          </div>
        </div>
      </section>
