...
export default function CustomCurtainsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Volledig op maat gemaakte gordijnen, perfect passend voor uw ramen.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: 'fa-cog', title: 'Diverse opties', desc: 'Plooien, ophangmethoden, afwerking' },
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white">15.000+</p>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">
            Gebruik onze handige configurator om uw perfecte gordijnen samen te stellen.
          </p>
          <Link
            href="/configurator"
