...
const products = [
  {
    id: 'inbetween-linen',
    name: 'Linnen Inbetween',
    description: 'Natuurlijke linnen inbetween gordijnen met perfecte balans.',
    price: 79,
    image: '/images/nav/curtain-inbetween.png',
    features: ['40% lichtdoorlatend', 'Linnen', 'Natuurlijk'],
  },
  {
    id: 'inbetween-cotton',
    name: 'Katoen Inbetween',
    description: 'Zachte katoenen inbetween voor een warme sfeer.',
    price: 69,
    image: '/images/nav/curtain-inbetween.png',
    features: ['45% lichtdoorlatend', 'Katoen', 'Wasbaar'],
  },
  {
    id: 'inbetween-blend',
    name: 'Blend Inbetween',
    description: 'Gemengde stoffen inbetween met uitstekende eigenschappen.',
    price: 59,
    image: '/images/nav/curtain-inbetween.png',
    features: ['50% lichtdoorlatend', 'Blend', 'Kreukvrij'],
  },
];

export default function InbetweenCurtainsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              De perfecte balans tussen privacy en lichtinval. Niet te open, niet te dicht.
            </p>
          </div>
        </div>
      </section>
