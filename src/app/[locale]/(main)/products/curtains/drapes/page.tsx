...
const products = [
  {
    id: 'drapes-velvet',
    name: 'Velvet Overgordijnen',
    description: 'Luxe velvet overgordijnen voor een warme, rijke uitstraling.',
    price: 149,
    image: '/images/nav/nav-gordijn-verduisterend.jpg',
    features: ['Velvet stof', 'Luxe uitstraling', 'Thermisch'],
  },
  {
    id: 'drapes-linen',
    name: 'Linnen Overgordijnen',
    description: 'Natuurlijke linnen overgordijnen met een klassieke look.',
    price: 119,
    image: '/images/nav/nav-gordijn-verduisterend.jpg',
    features: ['Linnen', 'Natuurlijk', 'Duurzaam'],
  },
  {
    id: 'drapes-cotton',
    name: 'Katoen Overgordijnen',
    description: 'Zachte katoenen overgordijnen voor een huiselijke sfeer.',
    price: 99,
    image: '/images/nav/nav-gordijn-verduisterend.jpg',
    features: ['Katoen', 'Zacht', 'Wasbaar'],
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Luxe overgordijnen voor een warme en stijlvolle uitstraling in uw interieur.
            </p>
          </div>
        </div>
      </section>
