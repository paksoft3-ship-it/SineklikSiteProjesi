...
const products = [
  {
    id: 'rails-aluminum',
    name: 'Aluminium Gordijnrails',
    description: 'Strakke aluminium rails voor een moderne uitstraling.',
    price: 29,
    image: '/images/nav/curtain-rails.png',
    features: ['Aluminium', 'Modern', 'Duurzaam'],
  },
  {
    id: 'rails-electric',
    name: 'Elektrische Gordijnrails',
    description: 'Gemotoriseerde rails voor optimaal comfort.',
    price: 149,
    image: '/images/nav/curtain-rails.png',
    features: ['Elektrisch', 'Afstandsbediening', 'Smart home'],
  },
  {
    id: 'rails-ceiling',
    name: 'Plafond Gordijnrails',
    description: 'Onzichtbare montage aan het plafond.',
    price: 49,
    image: '/images/nav/curtain-rails.png',
    features: ['Plafondmontage', 'Onzichtbaar', 'Strak'],
  },
];

export default function CurtainRailsPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Strakke rails voor een moderne, minimalistische look.
            </p>
          </div>
        </div>
      </section>
