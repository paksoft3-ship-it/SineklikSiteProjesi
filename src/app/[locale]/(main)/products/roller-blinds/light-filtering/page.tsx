...
const products = [
  { id: 1, name: 'Lichtdoorlatend Wit', price: '€49,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 2, name: 'Lichtdoorlatend Linnen', price: '€55,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 3, name: 'Lichtdoorlatend Beige', price: '€52,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 4, name: 'Lichtdoorlatend Grijs', price: '€55,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
];

export default function RollerBlindsLightFilteringPage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Lichtdoorlatende Rolgordijnen</h1>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Configureer uw lichtdoorlatende rolgordijn precies op maat.</p>
