...
const products = [
  { id: 1, name: 'Verduisterend Wit', price: '€59,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 2, name: 'Verduisterend Grijs', price: '€65,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 3, name: 'Verduisterend Zwart', price: '€65,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
  { id: 4, name: 'Verduisterend Crème', price: '€62,-', image: '/images/nav/nav-gordijn-verduisterend.jpg' },
];

export default function RollerBlindsBlackoutPage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Verduisterende Rolgordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">100% verduistering voor optimale slaap en privacy.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Configureer uw verduisterende rolgordijn precies op maat.</p>
