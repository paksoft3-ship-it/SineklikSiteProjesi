...
const products = [
  { id: 1, name: 'Screen 3% Wit', price: '€69,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 2, name: 'Screen 5% Grijs', price: '€72,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 3, name: 'Screen 3% Zwart', price: '€75,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
  { id: 4, name: 'Screen 10% Beige', price: '€65,-', image: '/images/nav/nav-gordijn-kleur.jpg' },
];

export default function RollerBlindsScreenPage() {
  return (
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Screen Rolgordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Zonwering met behoud van uitzicht - ideaal voor kantoren en woonkamers.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Configureer uw screen rolgordijn precies op maat.</p>
