...
const products = [
  {
    ...
    description: 'Lichte voile voor maximaal daglicht.',
    price: 39,
    image: '/images/nav/curtain-sheer.png',
    features: ['85% lichtdoorlatend', 'Voile', 'Subtiele privacy'],
  },
  {
    id: 'sheer-screen',
    name: 'Transparant Screen',
    description: 'Screen stof voor zonwering met uitzicht.',
    price: 49,
    image: '/images/nav/curtain-sheer.png',
    features: ['80% lichtdoorlatend', 'Screen', 'UV-bescherming'],
  },
  {
    id: 'sheer-linen',
    name: 'Transparant Linnen',
    description: 'Natuurlijke linnen look met transparantie.',
    price: 59,
    image: '/images/nav/curtain-sheer.png',
    features: ['75% lichtdoorlatend', 'Linnen look', 'Natuurlijk'],
  },
];

export default function SheerRollerPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Maximaal licht met subtiele privacy. Perfect voor een luchtige sfeer.
            </p>
          </div>
        </div>
      </section>
