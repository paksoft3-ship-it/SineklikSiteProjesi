...
export default function CustomRollerPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <span className="inline-block px-4 py-1 bg-yellow-500/20 text-yellow-300 text-sm font-semibold rounded-full mb-4">
              <i className="fas fa-star mr-2"></i>Bestseller
            </span>
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
              Rolgordijnen op Maat
            </h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Volledig op maat gemaakte rolgordijnen voor een perfecte pasvorm.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl font-bold text-secondary dark:text-white mb-6">
                Perfecte pasvorm gegarandeerd
              </h2>
              <div className="space-y-4">
                {[
                  { icon: 'fa-ruler-combined', title: 'Exact op maat', desc: 'Tot op de millimeter nauwkeurig' },
                  { icon: 'fa-palette', title: '100+ kleuren', desc: 'Uitgebreide kleurencollectie' },
                  { icon: 'fa-cog', title: 'Diverse opties', desc: 'Bediening, montage, cassette' },
              ...
              <div className="mt-8">
                <Link
                  href="/configurator"
                  className="inline-flex items-center px-6 py-3 bg-primary text-white font-bold rounded-lg hover:bg-blue-600 transition"
                >
