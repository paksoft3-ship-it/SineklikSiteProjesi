...
const products = [
  {
    id: 'light-standard',
    name: 'Lichtdoorlatend Standaard',
    description: 'Zachte lichtfiltering met privacy.',
    price: 49,
    image: '/images/nav/curtain-light.png',
    features: ['50% lichtdoorlatend', 'Privacy', 'UV-bescherming'],
  },
  {
    id: 'light-texture',
    name: 'Lichtdoorlatend Textuur',
    description: 'Met subtiele textuur voor extra sfeer.',
    price: 59,
    image: '/images/nav/curtain-light.png',
    features: ['55% lichtdoorlatend', 'Textuur', 'Decoratief'],
  },
  {
    id: 'light-linen',
    name: 'Lichtdoorlatend Linnen',
    description: 'Natuurlijke linnen look met goede lichtfiltering.',
    price: 69,
    image: '/images/nav/curtain-light.png',
    features: ['60% lichtdoorlatend', 'Linnen look', 'Natuurlijk'],
  },
];

export default function LightFilteringRollerPage() {
  return (
