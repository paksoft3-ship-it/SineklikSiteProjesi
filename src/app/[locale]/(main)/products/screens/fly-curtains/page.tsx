...
const products = [
  { id: 'fly-bamboo', name: 'Vliegengordijn Bamboe', description: 'Natuurlijk bamboe vliegengordijn.', price: 39, features: ['Bamboe', 'Natuurlijk', 'Decoratief'] },
  { id: 'fly-beaded', name: 'Vliegengordijn Kralen', description: 'Kleurrijke kralen vliegengordijn.', price: 29, features: ['Kralen', 'Kleurrijk', 'Retro'] },
  { id: 'fly-string', name: 'Vliegengordijn Draad', description: 'Modern draad vliegengordijn.', price: 35, features: ['Draad', 'Modern', 'Transparant'] },
];

export default function FlyCurtainsPage() {
  return (
      ...
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Vliegengordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Decoratieve vliegengordijnen die insecten buiten houden.</p>
          </div>
        </div>
      </section>
