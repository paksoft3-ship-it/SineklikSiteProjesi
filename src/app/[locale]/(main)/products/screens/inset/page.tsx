...
const products = [
  { id: 'inset-standard', name: 'Inzethor Standaard', description: 'Eenvoudig te plaatsen zonder boren.', price: 49, features: ['Geen boren', 'Aluminium frame', 'Glasvezel gaas'] },
  { id: 'inset-pet', name: 'Inzethor Pet-Screen', description: 'Extra sterk gaas voor huisdieren.', price: 69, features: ['Pet-Screen', 'Krasbestendig', 'Duurzaam'] },
  { id: 'inset-pollen', name: 'Inzethor Poll-Tex', description: 'Filtert pollen voor hooikoortslijders.', price: 79, features: ['Poll-Tex', 'Pollenfiltrerend', 'Allergievriendelijk'] },
];

export default function InsetScreensPage() {
  return (
      ...
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Eenvoudig te plaatsen zonder boren of schroeven. Perfect voor huurwoningen.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((product) => (
              <motion.div key={product.id} className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" whileHover={{ y: -8 }}>
                <div className="h-48 overflow-hidden"><img alt={product.name} className="w-full h-full object-cover" src="/images/nav/horren-inset.png" /></div>
                <div className="p-6">
