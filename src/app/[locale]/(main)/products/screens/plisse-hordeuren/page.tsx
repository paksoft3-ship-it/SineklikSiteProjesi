...
export const metadata: Metadata = {
  title: 'Plissé Hordeuren op Maat | Window Specialist',
  description: 'Elegante plissé hordeuren op maat. Ruimtebesparend en stijlvol voor balkons en terrassen.',
};

const features = [
  { icon: 'fa-compress-arrows-alt', title: 'Ruimtebesparend', description: 'Plisséconstructie neemt minimale ruimte in.' },
  { icon: 'fa-door-open', title: 'Eenvoudige doorgang', description: 'Soepele bediening met één hand.' },
  { icon: 'fa-palette', title: 'Stijlvol design', description: 'Modern en elegant in elk interieur.' },
    ...
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <Link href="/products/screens" className="inline-flex items-center text-blue-300 hover:text-blue-200 mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6">
                De elegante oplossing voor balkons en terrassen. Ruimtebesparend, stijlvol en eenvoudig te bedienen.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Configureer uw plissé hordeur op maat.</p>
          <Link href="/configurator" className="inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-bold rounded-lg text-white bg-primary hover:bg-blue-600 transition shadow-lg shadow-blue-500/30">
