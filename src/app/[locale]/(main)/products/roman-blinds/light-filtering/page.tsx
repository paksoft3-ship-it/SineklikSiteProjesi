...
const products = [
  { id: 'roman-light-white', name: 'Vouwgordijn Lichtdoorlatend Wit', description: 'Zachte lichtfiltering in klassiek wit.', price: 79, features: ['Lichtdoorlatend', 'Wit', 'UV-bescherming'] },
  { id: 'roman-light-natural', name: 'Vouwgordijn Lichtdoorlatend Naturel', description: 'Natuurlijke tint voor een warme sfeer.', price: 79, features: ['Lichtdoorlatend', 'Naturel', 'Natuurlijk'] },
  { id: 'roman-light-grey', name: 'Vouwgordijn Lichtdoorlatend Grijs', description: 'Modern grijs met zachte lichtfiltering.', price: 89, features: ['Lichtdoorlatend', 'Grijs', 'Modern'] },
];

export default function RomanLightFilteringPage() {
  return (
      ...
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Lichtdoorlatende Vouwgordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Zachte lichtfiltering met behoud van privacy.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((product) => (
              <motion.div key={product.id} className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" whileHover={{ y: -8 }}>
                <div className="h-48 overflow-hidden"><img alt={product.name} className="w-full h-full object-cover" src="/images/nav/roman_light_1769528427366.png" /></div>
                <div className="p-6">
