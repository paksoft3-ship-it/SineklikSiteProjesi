...
const products = [
  { id: 'roman-inbet-white', name: 'Vouwgordijn Inbetween Wit', description: 'Perfecte balans in klassiek wit.', price: 89, features: ['Inbetween', 'Wit', 'Balans'] },
  { id: 'roman-inbet-cream', name: 'Vouwgordijn Inbetween Crème', description: 'Warme crème voor een huiselijke sfeer.', price: 89, features: ['Inbetween', 'Crème', 'Warm'] },
  { id: 'roman-inbet-taupe', name: 'Vouwgordijn Inbetween Taupe', description: 'Elegante taupe kleur.', price: 99, features: ['Inbetween', 'Taupe', 'Elegant'] },
];

export default function RomanInbetweenPage() {
  return (
      ...
      <section className="bg-secondary dark:bg-bg-dark-2 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Inbetween Vouwgordijnen</h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Perfecte balans tussen licht en privacy.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {products.map((product) => (
              <motion.div key={product.id} className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all" whileHover={{ y: -8 }}>
                <div className="h-48 overflow-hidden"><img alt={product.name} className="w-full h-full object-cover" src="/images/nav/roman_inbetween_1769528574630.png" /></div>
                <div className="p-6">
