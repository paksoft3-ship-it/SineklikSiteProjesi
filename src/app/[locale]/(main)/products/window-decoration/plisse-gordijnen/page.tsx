...
export const metadata: Metadata = {
  ...
  description: 'Plissé gordijnen op maat - stijlvol en functioneel met uitstekende isolatie.',
};

const features = [
  { icon: 'fa-temperature-low', title: 'Isolerend', description: 'Houdt warmte binnen en kou buiten.' },
  { icon: 'fa-arrows-alt-v', title: 'Top-down/Bottom-up', description: 'Flexibele positionering mogelijk.' },
  { icon: 'fa-compress-alt', title: 'Compact', description: 'Neemt weinig ruimte in wanneer geopend.' },
    ...
    <div className="bg-bg-light-1 dark:bg-bg-dark-1 min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-lg text-gray-300 mb-6">
                Stijlvol en functioneel. Perfecte lichtregulatie met uitstekende isolerende eigenschappen.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Configureer uw plissé gordijn op maat.</p>
          <Link href="/configurator" className="inline-flex justify-center items-center px-8 py-4 border border-transparent text-base font-bold rounded-lg text-white bg-primary hover:bg-blue-600 transition shadow-lg shadow-blue-500/30">
