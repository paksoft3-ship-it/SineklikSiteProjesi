...
const products = [
  {
    id: 'bamboo-natural',
    name: 'Bamboe Naturel',
    description: 'Natuurlijke bamboe kleur voor een organische look.',
    price: 79,
    image: '/images/nav/wood_bamboo_1769529056827.png',
    features: ['Natuurlijke kleur', 'Duurzaam', 'Milieuvriendelijk'],
  },
  {
    id: 'bamboo-dark',
    name: 'Bamboe Donker',
    description: 'Donker gebeitste bamboe voor een warme uitstraling.',
    price: 89,
    image: '/images/nav/wood_bamboo_1769529056827.png',
    features: ['Donker gebeitst', 'Warm', 'Elegant'],
  },
  {
    id: 'bamboo-white',
    name: 'Bamboe Wit',
    description: 'Wit gelakte bamboe voor een frisse, moderne look.',
    price: 89,
    image: '/images/nav/wood_bamboo_1769529056827.png',
    features: ['Wit gelakt', 'Modern', 'Fris'],
  },
];

export default function BambooVenetianPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Duurzaam en milieuvriendelijk met een natuurlijke, warme uitstraling.
            </p>
          </div>
        </div>
      </section>
