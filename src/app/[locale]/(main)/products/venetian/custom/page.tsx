...
export default function CustomVenetianPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Volledig op maat gemaakte jaloezieën voor een perfecte pasvorm.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: 'fa-cog', title: 'Diverse opties', desc: 'Lamelbreedte, bediening, montage' },
