...
const products = [
  {
    id: 'pvc-white',
    name: 'PVC Wit',
    description: 'Klassiek wit PVC voor een frisse uitstraling.',
    price: 39,
    image: '/images/nav/wood_white_1769529243896.png',
    features: ['Wit', 'Vochtbestendig', 'Onderhoudsvriendelijk'],
  },
  {
    id: 'pvc-grey',
    name: 'PVC Grijs',
    description: 'Modern grijs PVC voor een hedendaagse look.',
    price: 39,
    image: '/images/nav/wood_white_1769529243896.png',
    features: ['Grijs', 'Modern', 'Duurzaam'],
  },
  {
    id: 'pvc-woodgrain',
    name: 'PVC Houtlook',
    description: 'PVC met houtnerf voor een warme uitstraling.',
    price: 49,
    image: '/images/nav/wood_50mm_1769528823646.png',
    features: ['Houtlook', 'Vochtbestendig', 'Budget-vriendelijk'],
  },
];

export default function PVCVenetianPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Vochtbestendig en onderhoudsvriendelijk. Ideaal voor badkamers en keukens.
            </p>
          </div>
        </div>
      </section>
