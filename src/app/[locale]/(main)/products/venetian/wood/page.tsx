...
const products = [
  {
    ...
    description: 'Klassieke 50mm lamellen voor een warme uitstraling.',
    price: 89,
    image: '/images/nav/wood_50mm_1769528823646.png',
    features: ['50mm lamellen', 'Basswood', 'Premium kwaliteit'],
  },
  {
    id: 'wood-63mm',
    name: 'Houten Jaloezie 63mm',
    description: 'Brede 63mm lamellen voor een moderne look.',
    price: 99,
    image: '/images/nav/wood_63mm_1769528959629.png',
    features: ['63mm lamellen', 'Basswood', 'Meer licht'],
  },
  {
    id: 'wood-basswood',
    name: 'Basswood Premium',
    description: 'Premium basswood met natuurlijke nerven.',
    price: 119,
    image: '/images/nav/wood_basswood_1769529125768.png',
    features: ['Premium hout', 'Natuurlijke nerven', 'Duurzaam'],
  },
];

export default function WoodVenetianPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Warme, natuurlijke uitstraling met premium houtsoorten. Tijdloze elegantie voor elk interieur.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-white dark:bg-gray-800 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: 'fa-tree', title: 'Echt Hout', desc: 'Premium basswood' },
              { icon: 'fa-sun', title: 'UV-bestendig', desc: 'Kleurvast' },
              { icon: 'fa-palette', title: '20+ Kleuren', desc: 'Beitsen & lakken' },
