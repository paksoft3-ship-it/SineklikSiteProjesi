        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href="/products/plisse-screens" className="bg-white dark:bg-gray-800 rounded-2xl p-6 hover:shadow-lg transition group">
              ...
              <Link href="/products/plisse-curtains" className="bg-white dark:bg-gray-800 rounded-2xl p-6 hover:shadow-lg transition group">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center group-hover:bg-primary/20 transition">
