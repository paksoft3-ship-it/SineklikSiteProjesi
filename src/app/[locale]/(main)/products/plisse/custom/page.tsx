...
export default function CustomPlissePage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
              Plissé Gordijnen op Maat
            </h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Volledig op maat gemaakte plissé gordijnen voor een perfecte pasvorm.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: 'fa-sun', title: 'Diverse lichtdoorlatendheid', desc: 'Van verduisterend tot transparant' },
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8">
            Gebruik onze handige configurator om uw perfecte plissé gordijnen samen te stellen.
          </p>
          <Link
            href="/configurator"
