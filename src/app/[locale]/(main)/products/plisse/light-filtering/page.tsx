...
const products = [
  {
    id: 'plisse-light-70',
    name: 'Plissé 70% Lichtdoorlatend',
    description: 'Zachte lichtfiltering met natuurlijk licht.',
    price: 79,
    image: '/images/nav/roman_light_1769528427366.png',
    features: ['70% lichtdoorlatend', 'Natuurlijk', 'UV-bescherming'],
  },
  {
    id: 'plisse-light-50',
    name: 'Plissé 50% Lichtdoorlatend',
    description: 'Goede balans tussen licht en privacy.',
    price: 79,
    image: '/images/nav/roman_light_1769528427366.png',
    features: ['50% lichtdoorlatend', 'Privacy', 'Balans'],
  },
  {
    id: 'plisse-light-honeycomb',
    name: 'Plissé Lichtdoorlatend Honeycomb',
    description: 'Honeycomb structuur met zachte lichtfiltering.',
    price: 99,
    image: '/images/nav/roman_light_1769528427366.png',
    features: ['60% lichtdoorlatend', 'Honeycomb', 'Isolerend'],
  },
];

export default function PlisseLightFilteringPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">
              Lichtdoorlatend Plissé
            </h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Zachte lichtfiltering met behoud van privacy. Perfect voor woonkamers.
            </p>
          </div>
        </div>
      </section>
