...
const products = [
  {
    id: 'plisse-sheer-90',
    name: 'Plissé 90% Transparant',
    description: 'Maximaal licht met subtiele privacy.',
    price: 69,
    image: '/images/nav/roman_linen_1769528689271.png',
    features: ['90% lichtdoorlatend', 'Transparant', 'Subtiele privacy'],
  },
  {
    id: 'plisse-sheer-voile',
    name: 'Plissé Voile',
    description: 'Lichte voile stof voor een luchtige sfeer.',
    price: 79,
    image: '/images/nav/roman_linen_1769528689271.png',
    features: ['85% lichtdoorlatend', 'Voile', 'Luchtig'],
  },
];

export default function PlisseSheerPage() {
  return (
