          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
            ...
            >
              <motion.span
                ...
                className="px-2 py-1 text-[10px] font-semibold tracking-wide uppercase rounded bg-red-100 text-red-700"
              >
                <i className="fas fa-temperature-low mr-1"></i>Warmtewering
              </motion.span>
              <motion.span
                variants={tagVariants}
            ...
            >
              Houd uw zolder koel in de zomer en warm in de winter met isolerende raamdecoratie.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <ScrollAnimation variant="fadeUp">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-display text-3xl font-bold text-secondary dark:text-white mb-4">
              Populair: Zolder Isolatie Pack
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Duette® Shades + Dakraamhor vanaf €199,-
            </p>
