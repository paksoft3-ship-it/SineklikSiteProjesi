        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
              Al meer dan 10 jaar de specialist in horren en raamdecoratie voor Nederlandse woningen. Vakmanschap, kwaliteit en persoonlijke service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/producten/horren" className="text-gray-400 hover:text-primary transition">
                  Horren
                </Link>
              </li>
              <li>
                <Link href="/producten/raamdecoratie" className="text-gray-400 hover:text-primary transition">
                  Raamdecoratie
                </Link>
              </li>
              <li>
                <Link href="/producten/raamdecoratie/rolgordijnen" className="text-gray-400 hover:text-primary transition">
                  Rolgordijnen
                </Link>
              </li>
              <li>
                <Link href="/producten/raamdecoratie/jaloezieen" className="text-gray-400 hover:text-primary transition">
                  Jaloezieën
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/kamers/woonkamer" className="text-gray-400 hover:text-primary transition">
                  Woonkamer
                </Link>
              </li>
              <li>
                <Link href="/kamers/slaapkamer" className="text-gray-400 hover:text-primary transition">
                  Slaapkamer
                </Link>
              </li>
              <li>
                <Link href="/kamers/keuken" className="text-gray-400 hover:text-primary transition">
                  Keuken
                </Link>
              </li>
              <li>
                <Link href="/kamers/badkamer" className="text-gray-400 hover:text-primary transition">
                  Badkamer
                </Link>
              </li>
            </ul>
