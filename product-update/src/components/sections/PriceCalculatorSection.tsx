...
const products = [
  // Plissé Horren
  { id: 'plisse-hor-deur', name: 'Plissé Hordeur', basePrice: 199, pricePerCm2: 0.0014, category: 'Plissé Horren' },
  { id: 'plisse-hor-raam', name: 'Plissé Raamhor', basePrice: 89, pricePerCm2: 0.001, category: 'Plissé Horren' },
  { id: 'plisse-hor-glazen-balkon', name: 'Glazen Balkon Hor', basePrice: 249, pricePerCm2: 0.0016, category: 'Plissé Horren' },
  { id: 'plisse-hor-vast', name: 'Vaste Plissé Hor', basePrice: 69, pricePerCm2: 0.0008, category: 'Plissé Horren' },
  { id: 'plisse-hor-binnenmontage', name: 'Binnenmontage Hor', basePrice: 79, pricePerCm2: 0.0009, category: 'Plissé Horren' },
  { id: 'plisse-hor-combinatie', name: 'Hor + Gordijn Combinatie', basePrice: 299, pricePerCm2: 0.002, category: 'Plissé Horren' },
  { id: 'plisse-hor-drempelloos', name: 'Drempelloze Plissé Hor', basePrice: 229, pricePerCm2: 0.0015, category: 'Plissé Horren' },
  // Plissé Gordijnen
  { id: 'plisse-gordijn-honeycomb', name: 'Honeycomb / Duette', basePrice: 129, pricePerCm2: 0.0015, category: 'Plissé Gordijnen' },
  { id: 'plisse-gordijn-verduisterend', name: 'Verduisterend Plissé', basePrice: 99, pricePerCm2: 0.0012, category: 'Plissé Gordijnen' },
  { id: 'plisse-gordijn-lichtdoorlatend', name: 'Lichtdoorlatend Plissé (70%)', basePrice: 79, pricePerCm2: 0.001, category: 'Plissé Gordijnen' },
  { id: 'plisse-gordijn-standaard', name: 'Standaard Plissé Gordijn', basePrice: 69, pricePerCm2: 0.0009, category: 'Plissé Gordijnen' },
];
